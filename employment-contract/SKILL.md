...
1. `{SKILL_DIR}/../shared/references/labor-law-checklist.md` — 근로기준법 §17 필수 5항목 + 5인 미만/이상 비교
2. `{SKILL_DIR}/../shared/references/minimum-wage-2026.md` — 2026 최저임금 10,320원, 가산수당 계산
3. `{SKILL_DIR}/../shared/references/four-insurance.md` — 4대보험 의무 가입 기준
4. `{SKILL_DIR}/../shared/references/contract-glossary.md` — 전문용어 쉬운 설명
5. `{SKILL_DIR}/../shared/references/penalty-risks.md` — 위반 시 제재

## 인터뷰 규칙

- `{SKILL_DIR}/../shared/interview-all.md`의 [근로계약서] 섹션 진행
...
`{SKILL_DIR}/../shared/interview-all.md`의 [근로계약서] Step 1~11 순차 진행.
...
`{SKILL_DIR}/../shared/render.md` 프로토콜 따라 `{SKILL_DIR}/../shared/templates/employment-contract.tmpl` 치환.
