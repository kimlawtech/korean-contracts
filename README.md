...
아래는 `/employment-contract` 스킬이 생성한 근로계약서 샘플입니다.

```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  [법적 면책 고지]
  본 계약서는 참고용 초안이며 법률 자문이 아닙니다.
  서명 전 반드시 노무사·변호사 검토를 받으십시오.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

                   근 로 계 약 서

주식회사 모카(이하 "회사")와 이직원(이하 "근로자")은
다음과 같이 근로계약을 체결한다.
...
① 이 계약은 2026년 5월 1일부터 기간의 정함이 없이 유효하다.

제2조 (수습 기간)

① 회사는 근로자에게 3개월의 수습 기간을 부여한다.
② 수습 기간 중 임금은 월 금 2,700,000원정으로 한다.

제3조 (근무 장소 및 업무 내용)

① 근무 장소: 서울특별시 강남구 테헤란로 123 주식회사 모카 본사
② 담당 업무: 마케터 — SNS 콘텐츠 기획 및 운영, Instagram·블로그 관리

제4조 (근로시간·휴게)

① 소정근로시간: 09:00 ~ 18:00 (1일 8시간, 주 40시간)
...
② 임금 지급일: 매월 25일 (근로기준법 §43)
③ 임금명세서: 매월 지급일에 이메일로 교부 (근로기준법 §48②)
④ 재직조건부 상여금은 정기·일률 지급 시 통상임금에 포함된다.
   (대법원 2024.12.19. 전원합의체 판결)

──────────────────────────────────────────────

[법률 검증 결과]
✅ RULE 1: 근로기준법 §17 필수 5항목 포함
✅ RULE 2: 고용 형태·계약기간 적정
✅ RULE 8: 최저임금 10,320원/시 이상 — 시급 환산 14,354원
✅ RULE 9: 5인 이상 사업장 조항 적용
✅ RULE 12: 통상임금 재직조건부 상여금 포함 문구 확인

[생성 완료]
  employment-contract-이직원-20260420.txt
  employment-contract-이직원-20260420.docx
저장 위치: ~/Desktop
```
